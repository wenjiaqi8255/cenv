...
echo ""
echo "Installation complete (cenv 1.0.0)!"
echo ""
echo "Next steps:"
echo "  1. Reload shell: source $SHELL_CONFIG"
echo "  2. Set API keys (for profiles.conf providers):"
...
echo "  4. For CC Switch users: cenv cc-switch list"
echo ""
echo "To update later: cenv update"
